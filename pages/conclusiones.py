...
def render():
    ...
    st.markdown(
        ...
        "alcance útil baja a ≈ 120 m. El caso de referencia a 100 m opera con amplio margen, "
        "bajo condiciones de propagación media estimada (corrección ITU-R P.1546, sin fading "
        "modelado).\n"
        "- A 100 m, P_DC = 1 335 µW, es decir un mensaje cada ≈ 194 s (unos 3,2 min). A 1 000 m "
        "la potencia cae a ≈ 13,4 µW; el V_DC ≈ 131,7 mV todavía supera los 130 mV que necesita el "
        "BQ25504 para arrancar, pero el período entre mensajes sube a ≈ 5,4 h.\n"
        "- La fase de transmisión se lleva casi toda la energía del ciclo: alrededor del 99,5 %.\n"
        "- El Sierpinski it. 3 sobre FR-4 adapta 1 de 7 bandas con una línea de 50 Ω "
        "(5G-3,5 GHz, S₁₁ = −17,4 dB), pero con co-diseño conjugado integrado el acople útil "
        "se recupera en 6 de 7. A niveles urbanos la cosecha (µW) queda limitada por el "
        "rectificador de baja señal, lo que sitúa a la multibanda en un régimen "
        "energía-asistido: sensores de muy bajo consumo con almacenamiento tampón.\n"
